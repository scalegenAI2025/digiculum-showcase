import { Lightbulb, Target, BookOpen, Code, Layers, Workflow, Briefcase, Sparkles, Clock, Award, ArrowRightCircle, GraduationCap } from "lucide-react";
...
const cards = [
  ...
  },
  {
    ...
    answer: "The Know–Hack–Build model is a framework for measuring an individual’s AIQ (AI Quotient)—the level of AI literacy and capability that will increasingly influence how people are evaluated and hired in the future.",
  },
  {
    icon: Briefcase,
  ...
  },
  {
    ...
    answer: "The program duration is 60 hours spanning over 21 consecutive days including weekends. Timings 8:30 - 10:30 pm IST ( 4 - 6 pm CET) on weekdays. 12 - 6 pm ( 7:30 am - 1:30 pm CET) on Saturdays and 12 - 4 pm (7:30 am - 11:30 pm CET) ",
  },
  {
    icon: Award,
  ...
  },
  {
    ...
    answer: "After completion of 21-day AI Practitioner Bootcamp, an individual can enroll in a 1-month AI Specialization Program.",
  },
  {
    icon: GraduationCap,
    question: "Why should I enroll in AI Specialization Program ?",
    answer: "The 1-month AI Specialization Program helps you turn the general AI skills and capabilities into job-specific advantage. ",
  },
];
...
const WhoIsAIPractitioner = () => {
  ...
  {cards.map((card, index) => (
    ...
    >
      ...
      <div
        className="
          mt-4 text-foreground/80 text-sm leading-relaxed
