    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="container mx-auto max-w-6xl text-center relative z-10">
          ...
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto mb-8">
            Develop comprehensive end-to-end strategies to successfully scale
            your AI/GenAI initiatives
          </p>
      ...
      <div className="container mx-auto max-w-6xl px-6 pb-24">
        ...
        <Card className="mb-8 bg-card/50 border-border/50">
          ...
          <CardContent className="text-foreground/80 space-y-4">
            <p>
              ...
              AI/GenAI transformation journey. Only a few have clarity where
              they are heading and what they want to do.
            </p>
            <p>
              Most of them deployed GenAI pilots without a scaling strategy. As
              a result, 90% pilots will not make it to production.
            </p>
        ...
        <Card className="mb-8 bg-card/50 border-border/50">
          ...
          <CardContent className="text-foreground/80 space-y-4">
            <p>
              GenAI pilots should be selected with a scaling strategy. Scaling
              strategy can be developed using the Digital Strategy Framework.
            </p>

            <div className="bg-muted/50 rounded-lg p-4">
              <p className="font-semibold text-foreground mb-3">
                The Digital Strategy Framework is an end-to-end framework
                comprising:
              </p>
          ...
          <CardContent className="text-foreground/80">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-card border border-border rounded-lg p-4">
                ...
                <p className="text-sm">
                  Differentiate from competitors with tailored strategies
                </p>
              </div>
              <div className="bg-card border border-border rounded-lg p-4">
                <h5 className="font-semibold text-primary mb-2">
          ...
          <CardContent className="text-foreground/80 space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="border-l-2 border-primary pl-4">
                ...
                <ul className="list-disc list-inside space-y-2 text-sm ml-2">
                  <li>
                    Evaluating the results of Digital Maturity, AI Maturity, and
              ...
              <div className="border-l-2 border-primary pl-4">
                ...
                <ul className="list-disc list-inside space-y-2 text-sm ml-2">
                  <li>
                    Business models, business case, use case, and productivity
                    gain
                  </li>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="bg-muted/30 rounded p-3">
                    <p>
                      ...
                      to set a guideline for end-to-end strategy creation and
                      execution
                    </p>
                  </div>
                  <div className="bg-muted/30 rounded p-3">
                    <p>
                      ...
                      as digital maturity, AI maturity and GenAI maturity
                    </p>
                  </div>
                  <div className="bg-muted/30 rounded p-3">
                    <p>
                      ...
                      to create strategy using Porter's 5 forces analysis
                    </p>
                  </div>
                  <div className="bg-muted/30 rounded p-3">
                    <p>
                      <strong className="text-primary">Critical Steps</strong>{" "}
                      for AI/GenAI strategy execution
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>
                      Continuous check-ins on strategy creation and execution
                    </li>
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/30 rounded-lg p-8">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Join our Transformation Strategy course and develop a
              comprehensive framework to successfully scale your AI initiatives.
            </p>
            <a href={import.meta.env.VITE_CALENDLY_URL} target="_blank">
              <Button size="lg" className="bg-primary hover:bg-primary/90">
                1:1 Consultation →
