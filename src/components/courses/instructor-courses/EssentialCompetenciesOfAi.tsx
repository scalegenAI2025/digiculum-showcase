      ...
      >
        ...
        <div className="container mx-auto max-w-6xl text-center relative z-10">
          ...
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto mb-8">
            Transform your leadership approach to successfully drive AI
        ...
        <Card className="mb-8 bg-card/50 border-border/50">
          ...
          <CardContent className="text-foreground/80 space-y-4">
            <p>
              ...
              dynamics, business models, competence requirements, and project
              parameters are constantly changing.
            </p>
            <p>
              But the leadership required to drive these changes has not changed
              much. Most leaders still use the pre-digital style of leadership
              to drive risky and uncertain AI transformation projects.
            </p>
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 mt-4">
              <p className="font-semibold text-foreground">
                This results in slow adoption or even failure of AI
        ...
        <Card className="mb-8 bg-card/50 border-border/50">
          ...
          <CardContent className="text-foreground/80 space-y-6">
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="border-l-2 border-primary pl-4">
                  ...
                  <p className="text-sm">
                    Cultivate readiness for continuous learning and adaptation
                  </p>
                </div>
                <div className="border-l-2 border-primary pl-4">
                  <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-sm">
                    Build stronger connections and empower your team
                  </p>
                </div>
                <div className="border-l-2 border-primary pl-4">
                  <div className="flex items-center gap-2 mb-2">
                ...
                <div className="border-l-2 border-primary pl-4">
                  ...
                  <p className="text-sm">
                    Drive rapid implementation and scaling
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-muted/50 rounded-lg p-4 mt-4">
              <p className="font-semibold text-foreground">
                The Digital Leadership Framework provides step-by-step
                guidelines to cultivate these competencies.
              </p>
            </div>
              ...
              <div className="space-y-6">
                <div className="border-l-2 border-primary pl-4">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-sm ml-2">
                    ...
                    <li>
                      Using empathy for team building, stakeholder management
                      and influencing, networking, mentoring, and reverse
                      mentoring
                    </li>
                ...
                <div className="border-l-2 border-primary pl-4">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-sm ml-2">
                    ...
                    <li>
                      Tackling the most challenging decision: Should we invest
                      in AI/GenAI?
                    </li>
                  </ul>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-muted/30 rounded p-3">
                    <p>
                      ...
                      for reinforcing connections with key AI stakeholders
                    </p>
                  </div>
                  <div className="bg-muted/30 rounded p-3">
                    <p>
                      ...
                      for identifying AI/GenAI investment areas
                    </p>
                  </div>
                  <div className="bg-muted/30 rounded p-3">
                    <p>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>
                      Continuous check-ins on implementation of the four
                      competencies
                    </li>
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/30 rounded-lg p-8">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Join our Digital Leadership course and develop the essential
              competencies needed to drive successful AI transformation in your
              organization.
            </p>
            <a href={import.meta.env.VITE_CALENDLY_URL} target="_blank">
              <Button size="lg" className="bg-primary hover:bg-primary/90">
