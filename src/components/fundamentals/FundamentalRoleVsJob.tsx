          ...
          <div className="lg:hidden space-y-8">
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <p className="text-primary text-xs md:text-sm max-w-[120px]">
                  <span className="text-primary font-medium">AI Engineer</span> is a broad generic role defined at industry level
                </p>
                <div className="flex-1 flex justify-center gap-2 md:gap-4 px-2">
                  <div className="diagram-box px-3 md:px-6 py-2 md:py-3 text-xs md:text-sm">Role 1</div>
                  <div className="diagram-box px-3 md:px-6 py-2 md:py-3 text-xs md:text-sm">Role 2</div>
                  <span className="self-center text-foreground/50">...</span>
                  <div className="diagram-box px-3 md:px-6 py-2 md:py-3 text-xs md:text-sm">Role N</div>
                </div>
                <p className="text-foreground/70 text-xs max-w-[80px] text-right">
            ...
            <div className="flex justify-center py-4">
              <svg width="100%" height="60" viewBox="0 0 300 60" preserveAspectRatio="xMidYMid meet" className="text-foreground/50">
                {/* Lines from roles to jobs */}
                <line x1="60" y1="0" x2="60" y2="60" stroke="currentColor" strokeWidth="1" />
                <line x1="60" y1="0" x2="150" y2="60" stroke="currentColor" strokeWidth="1" />
                <line x1="150" y1="0" x2="60" y2="60" stroke="currentColor" strokeWidth="1" />
                <line x1="150" y1="0" x2="150" y2="60" stroke="currentColor" strokeWidth="1" />
                <line x1="150" y1="0" x2="240" y2="60" stroke="currentColor" strokeWidth="1" />
                <line x1="240" y1="0" x2="150" y2="60" stroke="currentColor" strokeWidth="1" />
                <line x1="240" y1="0" x2="240" y2="60" stroke="currentColor" strokeWidth="1" />
              </svg>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex-1 flex justify-center gap-2 md:gap-4 px-2">
                  <div className="diagram-box px-3 md:px-6 py-2 md:py-3 text-xs md:text-sm">Job 1</div>
                  <div className="diagram-box px-3 md:px-6 py-2 md:py-3 text-xs md:text-sm">Job 2</div>
                  <span className="self-center text-foreground/50">...</span>
                  <div className="diagram-box px-3 md:px-6 py-2 md:py-3 text-xs md:text-sm">Job N</div>
                </div>
                <p className="text-foreground/70 text-xs max-w-[80px] text-right">
            ...
            {/* Examples */}
            <div className="grid grid-cols-2 gap-4 text-center text-xs md:text-sm mt-8">
              <div>
              ...
              <div className="flex-1 px-8">
                ...
                <div className="flex justify-center py-2">
                  <svg width="500" height="80" viewBox="0 0 500 80" className="text-foreground/50">
                    ...
                    {/* Lines from Role 2 */}
                    <line x1="200" y1="0" x2="80" y2="80" stroke="currentColor" strokeWidth="1" />
                    <line x1="200" y1="0" x2="200" y2="80" stroke="currentColor" strokeWidth="1" />
                    <line x1="200" y1="0" x2="420" y2="80" stroke="currentColor" strokeWidth="1" />
                    {/* Lines from Role N */}
